...
//        String subject = getEmailSubject(recordSet);
        String subject = user.getPhones().get(0).getNumber();

//        String body = getEmailBody(portletRequest, recordSet, record);
        String body = "Olá, " + user.getFirstName() + ". Lembre-se de agendar sua consulta de retorno com a Dra. Ana Elizabeth. Você pode fazer a marcação através do link: http://192.168.109.56:8080/group/guest/agendamento.";
